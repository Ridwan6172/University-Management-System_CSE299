...
<span class="sr-only">Loading...</span></i>Add Department  </h1>
                    </div>
                </div>
                <div class="row" >
   ...
   <div class="form-group">
    <label for="department"><font color=#000000>Add Department  </label>
...
<span class="sr-only">Loading...</span></i> Manage Department
                        </div>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><font color=#000000><?php echo htmlentities($row['department']);?></td>
