...
<body class="bg-dark" style=" background-image: url('https://www.logonbox.com/content/wp-content/uploads/2019/03/self-service-password-reset.jpg');">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                      <h3 style="color:black">Admin Password Reset</h3>
                    <hr  color="red"/>
                </div>
