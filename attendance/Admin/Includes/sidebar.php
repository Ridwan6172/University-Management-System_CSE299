      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createClass.php"><font color=#000000>Create Class</a></font>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapusers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createClassArms.php"><font color=#000000>Create Class Sections</a></font>
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Class Teachers</h6>
             <a class="collapse-item" href="createClassTeacher.php"><font color=#000000>Create Class Teachers</a></font>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createStudents.php"><font color=#000000>Create Students</a></font>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="createSessionTerm.php"><font color=#000000>Create Session and Year</a></font>
