...
if($category == 'General' || $category == 'Person With Autism' )
...
{$sql3="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 $sql5="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Your request for the book and the Book Id: $bookid  has been accepted...Thank You...',curdate(),curtime())";
...
{$sql4="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 $sql6="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Your request for the book and the Book Id: $bookid has been accepted...Thank You...',curdate(),curtime())";
