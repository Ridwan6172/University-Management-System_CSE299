...
<body>
	<img src="login-ui\images\cc.png" width="1600px" height="150px">
            </a>
        </div>
    </div>
            ...
            <div class="login-form">
               <h1><div class="row" >
                  <div class="col-md-3"></div>
                    <div class="col-md-7"><marquee>Admin Exam Portal</marquee></h1>
				...
				<form method="post" id="adminLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<h1><span class="label-input100">Enter</span><font color=#000000>
						<input class="input100" type="text" name="username" placeholder="username">
						<span class="focus-input100"></span></font>
					

					<div class="wrap-input100 validate-input m-b-26" data-validate = "Password is required">
						<span class="label-input100">Enter</span><font color=#000000>
						<input class="input100" type="password" name="pass" placeholder="password">
						<span class="focus-input100"></span></font></h1>
					</div>
<hr />
