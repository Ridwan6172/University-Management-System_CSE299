                            ...
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover"
                                ...
                                while ($selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <tr>
                                        <td>
                                            <b>
                                                <p><?php echo $i++; ?> .) <?php echo htmlspecialchars($selQuestRow['exam_question']); ?></p>
                                            </b>
                                            <label class="pl-4 text-success">
                                                Answer :
                                                <?php if ($selQuestRow['exam_answer'] != $selQuestRow['exans_answer']) { ?>
                                                    <span style="color:red"><?php echo htmlspecialchars($selQuestRow['exans_answer']); ?></span>
                                                <?PHP } else { ?>
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white">
                                        ...
                                        <span>
                                            ...
                                            <?php
                                            $over = htmlspecialchars($selExam['ex_questlimit_display']);
                                            ?>
                                        </span> / <?php echo $over; ?>
                                    </div>
                                </div>
