        ...
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <?php
                 $selectedExaminee = $conn->query("SELECT * FROM examinee_tbl WHERE exmne_id='$exmneId' ")->fetch(PDO::FETCH_ASSOC);
               ?>
              <input type="radio" name="asMe" value="<?php echo $selectedExaminee['exmne_fullname']; ?>"> <?php echo $selectedExaminee['exmne_fullname']; ?> <br>
              <input type="radio" name="asMe" value="Anonymous"> Anonymous
            </div>
            <div class="form-group">
              <textarea name="myFeedbacks" class="form-control" rows="3" placeholder="Enter your feedback here.."></textarea>
            </div>
          </div>
        </div>
