...
<div class="profile">
			<h3 style="font-size:18px;text-align:center;background:white;color:#fff;padding:10px;margin:0"><font color=#000000>Update Profile</h3>							
				<?php
					...
					if($_SERVER['REQUEST_METHOD'] == "POST"){
						...
						if(empty($st_name) or empty($st_email) or empty($st_contact) or empty($st_dept) or empty($st_gender) or empty($st_add)){
							...
							if($update){
								echo "<h4 style='color:white;text-align:center'>Information Updated successfully</h4>";
							}else{
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<table class="tab_one" >
						...
						<tr>
							...
							<td>Name:</td>
							<td><font color=#000000><input type="text" name="st_name" value="<?php echo $row['name'];?>"></td>
						</tr>
						<tr>
							<td style="width:125px;"></td>
							<td>E-mail:</td>
							<td><font color=#000000><input type="email" name="st_email" value="<?php echo $row['email']; ?>"></td>
						</tr>
						<tr>
							<td style="width:125px;"></td>
							<td>Program:</td>
							<td><font color=#000000><input type="text" name="st_dept" value="<?php echo $row['program']; ?>"></td>
						</tr>
						<tr>
							<td style="width:125px;"></td>
							<td>Contact:</td>
							<td><font color=#000000><input type="text" name="st_contact" value="<?php echo $row['contact']; ?>"></td>
						</tr>
						<tr>
							<td style="width:125px;"></td>
							<td>Gender:</td>
							<td><font color=#000000><input type="text" name="st_gender" value="<?php echo $row['gender']; ?>"></td>
						</tr>
						<tr>
							<td style="width:125px;"></td>
							<td>Address:</td>
							<td><font color=#000000><input type="text" name="st_add" value="<?php echo $row['address']; ?>"></td>
						</tr>
						<tr>
						<td style="width:125px;"></td>
						<td></td>
			...
			<div class="back fix">
				<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn"><font color=#000000>Back to student Profile</button></a></p>
			</div>
</div>
