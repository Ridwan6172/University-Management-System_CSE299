...
<div class="all_student fix">
    ...
    <div class="fix">
        <p style='text-align:center;background:white;color:black;padding:5px;width:84%;margin:0 auto'>All Completed Course & Grade</p>
    </div>
    ...
    <div class="back fix">
        <p style="text-align:center">
            <a href="view_single_result.php?vr=<?php echo $stid ?>&vn=<?php echo $name ?>">
                <button class="editbtn"><font color=#000000>Go to result page</button>
            </a>
        </p>
    </div>
</div>
