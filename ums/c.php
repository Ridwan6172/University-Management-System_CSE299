        ...
        <?php
          if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            if(empty($newpass) or empty($oldpass) or empty($confirmpass)){
              ...
              $oldpass = md5($oldpass);
              $newpass = md5($newpass);
              $user->updatePassword($admin_id, $newpass, $oldpass);
            }
          }
        ?>
        ...
        <form action="" method="post">
          ...
          <table class="tab_one" >
            <tr>
              ...
              <td><font color=#000000><input type="text" name="oldpass" placeholder="old password" /></td>
            </tr>
            <tr>
              <td style="width:125px;"></td>
              <td>New Password:</td>
              <td><font color=#000000><input type="text" name="newpass" placeholder="New password" /></td>
            </tr>
            <tr>
              <td style="width:125px;"></td>
              <td>Confirm Password:</td>
              <td><font color=#000000><input type="text" name="confirmpass" placeholder="Confirm password" /></td>
            </tr>
