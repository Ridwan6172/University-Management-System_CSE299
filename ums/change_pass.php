            ...
            ?>
                <table class="tab_one">
                    <tr>
                        ...
                        <td><font color=#000000><input type="password" name="oldpass" placeholder="Old password" /></td>
                    </tr>
                    <tr>
                        <td style="width:125px;"></td>
                        <td>New Password:</td>
                        <td><font color=#000000><input type="password" name="newpass" placeholder="New password" /></td>
                    </tr>
                    <tr>
                        <td style="width:125px;"></td>
                        <td>Confirm Password:</td>
                        <td><font color=#000000><input type="password" name="confirmpass" placeholder="Confirm password" /></td>
                    </tr>
                    <tr>
                        <td style="width:125px;"></td>
                        <td></td>
