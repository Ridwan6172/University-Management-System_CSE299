...
?>
<div class="profile">
		<p style="font-size:18px;text-align:center;background:white;color:#fff;padding:10px;margin:0"><font color=#000000><?php $user->getusername($st_id); ?> </p>
		<table class="tab_one">
			<?php
			...
			<tr>
				...
				<td><a href="admin_single_student_update.php?id=<?php echo $row['st_id'];?>"><button class="editbtn"><font color=#000000>Edit Profile</button></a></td>
			</tr>
			<?php  } ?>
		</table>
		<div class="back fix">
